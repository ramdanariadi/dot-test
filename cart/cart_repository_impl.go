...
func (repository CartRepositoryImpl) FindByUserId(context context.Context, tx *sql.Tx, userId string) []CartModel {
...
func (repository CartRepositoryImpl) Save(context context.Context, tx *sql.Tx, product CartModel) bool {
